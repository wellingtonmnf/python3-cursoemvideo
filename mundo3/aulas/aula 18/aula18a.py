...
galera.append(teste) # Acrescenta O OBJETO 'TESTE' do tipo lista no índice 0 da nova lista
teste[0] = 'Maria' # Modifica o valor do índice 0 no objeto 'teste'
teste[1] = 22 # Modifica o valor do índice 1 no objeto 'teste'
galera.append(teste) # Acrescenta novamente O MESMO OBJETO 'teste' (mesma variável de referência do objeto que teve valores alterados) no índice 1 da nova lista
